...
public class UserDataSource {
    ...
    {
        users.add(new User(1, "John", "Forth", 35, "actor"));
        users.add(new User(2, "Jayce", "Lucas", 35, "driver"));
        users.add(new User(3, "Jack", "Sparrow", 18, "gamer"));
        users.add(new User(4, "Dougles", "Rain", 55, "chef"));
    ...
    {
        // your code here
        Optional<User> jobOfTheOldestUser = users.stream().max(Comparator.comparing(User::getAge));
        return jobOfTheOldestUser.isPresent() ? jobOfTheOldestUser.get().getJob() : "NOT FOUND";
    }
