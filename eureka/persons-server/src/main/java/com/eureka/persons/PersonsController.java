...
import com.eureka.persons.util.NumberGenerator;
...
import static com.eureka.persons.base.AbstractEntity.COMPARATOR_BY_ID;
...
public class PersonsController {
    ...
    @PostMapping
    public void create(@RequestBody Person person, BindingResult result, @Value("#{request.requestURL}")
